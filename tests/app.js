function register(){
 ...
 const url =  'http://zaka.nouveta.co.ke/api/index.php?function=pay'
...
//   fetch('http://zaka.nouveta.co.ke/api/index.php?function=pay', {
//   method: 'post',
//   headers: {
...
//   .then(res => console.log(res));
  ...
  // axios.post('http://zaka.nouveta.co.ke/api/index.php?function=pay', {
  //   amount: cash,
  //   phoneNumber: number,
